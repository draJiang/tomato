...
function stopTomato() {
    ...
    status = enum_1.Status.Standby; //默认状态
    webextension_polyfill_1.default.action.setBadgeText({ text: '' });
    if (activeTab) {
        // 隐藏进度条
        webextension_polyfill_1.default.tabs.sendMessage(activeTab, {
...
function updateTomato(n) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        console.log(data);
        webextension_polyfill_1.default.storage.local.set({ 'tomato': data.tomato });
        // 通知 Popup 更新
        if (portToPopup) {
            const response = {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.validate = exports.checkWebsite = void 0;
const enum_1 = __webpack_require__(/*! ../enum */ "./src/enum.ts");
const webextension_polyfill_1 = __importDefault(__webpack_require__(/*! webextension-polyfill */ "./node_modules/webextension-polyfill/dist/browser-polyfill.js"));
// let website = [
